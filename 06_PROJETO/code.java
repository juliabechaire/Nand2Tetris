...
public class code {
    ...
    static {
        ...
        destTable.put("", "000");   destTable.put("M", "001");   destTable.put("D", "010");   destTable.put("MD", "011");
        destTable.put("A", "100");  destTable.put("AM", "101");  destTable.put("AD", "110");  destTable.put("AMD", "111");

        jumpTable.put("", "000");   jumpTable.put("JGT", "001"); jumpTable.put("JEQ", "010"); jumpTable.put("JGE", "011");
        jumpTable.put("JLT", "100"); jumpTable.put("JNE", "101"); jumpTable.put("JLE", "110"); jumpTable.put("JMP", "111");
    }

    public static String comp(String mnemonic) { return compTable.get(mnemonic); }
    public static String dest(String mnemonic) { return destTable.get(mnemonic); }
    public static String jump(String mnemonic) { return jumpTable.get(mnemonic); }
}